...
1.  Añade procesos indicando:
    *   **PID**
    *   **Tiempo de llegada**
    *   **Ráfaga**
    *   **Páginas necesarias**
2.  Selecciona un algoritmo de planificación.
3.  Configura (si aplica) el **quantum** para RR.
...
## 1️ **Modelo de datos: representación clara de procesos**
...
## 2️ **Simulación central: CPU + memoria trabajando juntas**
